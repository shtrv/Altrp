...
export default function renderInputRadio(settings, device) {
  ...
  const renderRepeatedInput = () => {
    const inline = getResponsiveSetting(settings,"vertical_radio", device, false);
  ...
  return `<div class="altrp-field-container altrp-field-radio-container " style="${containerClass}">
